...
axs[0].plot(days, drinks_sales, linestyle='--', color='blue', marker='H', markersize=8, markerfacecolor='magenta', markeredgecolor='black')
...
axs[1].plot(days, food_sales, linestyle='-', color='red', marker='D', markersize=8, markerfacecolor='green', markeredgecolor='red')
